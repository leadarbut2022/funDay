            ...
            <div style="width: 51%;">
                            ...
                            <div id="login-column" class="col-md-6">
                                <div id="login-box" class="col-md-12">
                                    <form action="loginteketer" id="login-form" class="form"  method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="email" id="number" value="{{ Cookie::get('emailtiketer'); }}" class="form-control">
                                            <span class="text-danger">@error('email'){{ $message }} @enderror</span>
                                        </div>
                                        <div class="form-group">
                                            <label for="password" class="text-info">كلمه المرور</label><br>
                                            <input type="text" name="password_" id="password"  value="{{ Cookie::get('passwordticeter'); }}" class="form-control">
